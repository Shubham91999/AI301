...
- Repo: `codepath/pathreview-ai301-fa26-s3` <!-- from the Unit 1 Check-In page -->
...
I am experienced with Python, JavaScript, and TypeScript. I want to improve my ability to read unfamiliar codebases quickly and make surgical fixes without refactoring. I prefer issues in documentation or bug fixes over feature additions. I will not take issues that require learning a new language or framework from scratch in the same week.
